...
exports.signUp = (req, res) => {
    ...
    ParkingHouse.findOne({ displayName: displayName }, function (err, parkingHouse) {
        ...
        newParkingHouse.save().then(data => {
...
exports.modify = (req, res) => {
    ...
    ParkingHouse.findOneAndUpdate(req.params.parkingHouseIdentifier, { $set: { displayName: displayName } }, { multi: true, safe: true }, function (err, parkinghouse) {
